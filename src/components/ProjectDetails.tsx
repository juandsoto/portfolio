	...
	return (
		...
		>
			<motion.div
				...
				className="relative max-w-screen-xl w-[95vw] sm:w-[85vw] md:w-[65vw] lg:w-[90vw] 2xl:w-[80vw] min-h-[48rem] max-h-[80vh] flex flex-col lg:flex-row rounded-lg bg-light shadow-sm dark:shadow-gray-700 dark:bg-dark"
