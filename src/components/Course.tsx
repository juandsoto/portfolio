...
const Course = ({ course }: Props) => {
  ...
  return (
    <div className="course">
      <div className="overflow-hidden flex items-center w-full h-full rounded-lg">
      ...
      <div className="course__overlay">
        ...
        <div className="flex-1 flex flex-col gap-4 justify-center items-center">
          <h4 className="text-center font-bold text-base sm:text-lg">{name}</h4>
          <a className="btn-primary" href={course_link} target="_blank" rel="noopener noreferrer">
            Go to course
          </a>
