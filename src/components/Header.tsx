...
export const Header = () => {
  ...
  return (
    <div
      className={[
        'fixed z-40 left-1/2 -translate-x-1/2 w-full bg-light dark:bg-dark',
        isScrolled && 'shadow dark:shadow-gray-700',
      ].join(' ')}
    >
      {breakpoint.sm() ? (
        <div className="section max-w-6xl">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4 items-center">
              ...
              {theme === 'light' ? (
                <span className="icon">
                  <LightModeOutlined
                    className="cursor-pointer text-secondary drop-shadow"
          ...
          <div
            className={[
              'bg-light dark:bg-dark mt-4 w-fit mx-auto',
              isMenuOpen ? 'h-48 mobile-breakpoint:h-12' : 'h-0 mt-0',
            ].join(' ')}
            style={{
          ...
          >
            <ul className="flex flex-col mobile-breakpoint:flex-row items-center gap-6">
              ...
              <li>
                <a href="#certificates" onClick={toggleMenu}>
                  Certificates
                </a>
              </li>
            </ul>
        ...
        <div className="section max-w-6xl mx-auto flex justify-between items-center">
          <div className="w-8">
            <a href="#">
              <HomeOutlined className="text-secondary" fontSize="medium" />
            </a>
          </div>
